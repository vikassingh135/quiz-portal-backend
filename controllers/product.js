...
exports.productById = (req, res, next, id) => {
    console.log("Galat jagah4 aaye ho bhaiya");
...
exports.list = (req, res) => {
    console.log("Sahi jagah aaye ho bhaiya");
...
exports.listRelated = (req, res) => {
    console.log("Galat jagah1 aaye ho bhaiya");
    let limit = req.query.limit ? parseInt(req.query.limit) : 6;
...
exports.listCategories = (req, res) => {
    console.log("Galat jagah2 aaye ho bhaiya");
...
exports.listBySearch = (req, res) => {
    console.log("Galat jagah3 aaye ho bhaiya");
